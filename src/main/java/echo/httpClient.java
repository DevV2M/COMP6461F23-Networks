...
//        get(pathWithQuery, endpoint, headers);
        ...
        put(pathWithQuery, "httpbin.org",endpoint, headers);
    }
    ...
    private static void get(String path, SocketAddress address, Map<String, String> headers) {
        ...
        private static void put(String path1, String host, SocketAddress address, Map<String, String> headers) throws IOException {
